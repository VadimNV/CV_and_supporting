...
\newcommand{\vcardfront}[5]{\ticket{%
    \put( 63, 5){\transparent{0.4}\includegraphics[width=30mm,angle=0,origin=bl]{vadim3.jpg}}
...
\whiledo{\thenumcards<10}{%
  ...
  \vcardfront{Vadim Nemytov}{Mathematical modelling\\ aa}{+YY/XXXX/ZZZ ZZ ZZ}{+YY/XXXX/ZZZ ZZ ZZ}{yourmail@your-provider.xxx}}
